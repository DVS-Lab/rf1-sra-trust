...
while IFS= read -r subject; do
    ...
    files=$(ls -1 "/ZPOOL/data/projects/rf1-sra-trust/derivatives/fsl/sub-$subject/L2_task-trust_model-1_type-act_sm-5.gfeat/cope4.feat/stats/cope1.nii.gz" 2>/dev/null)
