...
# Change to your task
# This should be the only thing that needs changed 
task = "trust"

# Path to the TSV files
path = "/ZPOOL/data/projects/rf1-sra-data/derivatives/fmriprep/sub-*/func/*task*_desc-confounds_timeseries.tsv"
