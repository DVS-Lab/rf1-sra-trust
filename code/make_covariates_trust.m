...
cov_data = [data.sub_id_rf1_data, data.sub_age, data.oafem_total, data.ios_friend_score-data.ios_computer_score, data.ios_friend_score-data.ios_stranger_score];
behavioral_data = [];
...
final_output_age= [subject_output(:,'subject'), ones_output(:,'ones'), demeaned_output(:,'age')];
...
fileoutput = [dest_path];
writetable(final_output_age, fileoutput); % Save as csv file
