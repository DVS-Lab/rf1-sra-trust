...
active=(project_config.sh BIDSto3col.sh gen3colfiles.sh run_gen3colfiles.sh L1stats.sh run_L1stats.sh run_L1_activation_ppi.sh audit_L1_activation_ppi.sh L2stats.sh run_L2stats.sh run_logged.sh validate_workflow.sh)
...
production=(project_config.sh BIDSto3col.sh gen3colfiles.sh run_gen3colfiles.sh L1stats.sh run_L1stats.sh run_L1_activation_ppi.sh audit_L1_activation_ppi.sh L2stats.sh run_L2stats.sh run_logged.sh)
