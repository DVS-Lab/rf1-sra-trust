...
PYTHONPYCACHEPREFIX="${TMPDIR:-/tmp}/trust-pycache" python3 -m py_compile "${SCRIPT_DIR}/build_L1_manifest.py" "${SCRIPT_DIR}/build_L2_manifest.py" "${SCRIPT_DIR}/trust_qc.py"
